<?php
  ...
  $sql = "INSERT INTO rooms (room_number, room_name, room_type, room_price, room_image, room_floor, room_beds, bed_type, room_capacity, room_amenities) VALUES (:room_number, :room_name, :room_type, :room_price, :room_image, :room_floor, :room_beds, :bed_type, :room_capacity, :room_amenities)";
