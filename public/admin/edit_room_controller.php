<?php
  ...
  $sql = "UPDATE rooms SET room_number = :room_number, room_name = :room_name, room_type = :room_type, room_price = :room_price, room_floor = :room_floor, room_beds = :room_beds, bed_type = :bed_type, room_capacity = :room_capacity, room_amenities = :room_amenities, room_image = :room_image WHERE room_id = :room_id";
