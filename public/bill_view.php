...
include("./config.php");
    ...
    if(isset($_GET["reservation_id"])) {
        ...
        $total_amount= abs ($room_price * $no_days);;
        ...
        <div id="page-wrap">
            ...
            <div id="customer">
                ...
                <p id="customer-title">Nyuat Hotel Reservation System</p>
                ...
                <table id="meta">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="due">Ksh.'.$total_cost.'</div>
                        </td>
                    </tr>
            ...
            <table id="items">
                ...
                <tr class="item-row">
                    ...
                    <td>
                        <p class="cost">Ksh.'.$total_cost.'</p>
                    </td>
                    <td>
                        <p class="qty">'.$no_days.' days</p>
                    </td>
                    <td><span class="price">Ksh.'.$total_cost.'</span></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="total-value">
                        <div id="subtotal">Ksh.'.$total_amount.'</div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="total-value">
                        <div id="total">Ksh.'.$total_amount.'</div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" class="blank"> </td>
